...
A country banking game: read the file, say yes or no, and keep enough in the safe.
...
## Keywords
the ledger, strategy, simulation, offline, campaign, tycoon

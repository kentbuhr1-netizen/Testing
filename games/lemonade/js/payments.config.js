 ...
 *
 * Leave both blank and the game is the complete game — every city, no
 * paywall — which is what you want when running it yourself or working on it.
 * Fill both in on the copy you host, and everything past the free cities
 * asks to be bought.
 *
